...
%motion for 12.5 degree leg angle
...
for index=1:length(time)
    ...
    %plane
    planeO=[-.1616,-0.0944,0.0472];         %origin of plane 
    
    %equation for plane
    fcns(1)=-0.468514566*(x-planeO(1))+2.113086486*(y-planeO(2))+0.3724874742*(z-planeO(3));
...
% 
relativetipmotion12_5.x=tipx-planeO(1);
relativetipmotion12_5.y=tipy-planeO(2);
relativetipmotion12_5.z=tipz-planeO(3);
relativetipmotion12_5.time=time;

save('relativetipmotion12_5.mat','relativetipmotion12_5')
...
figure
plot(relativetipmotion12_5.x,relativetipmotion12_5.y)
hold on
plot(relativetipmotion12_5.x,relativetipmotion12_5.x*tand(12.5)-0.0185,'r')
